    ...
    <div class="box11 animated_hero" style="background: #695FFE;">
      <div class="box-inside">
        <div class="desktop-mobile-view">
          ...
          <!-- //end top header -->
          <h1 style="font-weight: 800;color:darkorange" class="my-4">Batchwise Attendance</h1>
          <div class="batch-attendance">
            <?php foreach($student_attedence_batch as $batch) {?>
            <a href="<?php echo site_url("teacher/attendance/".$batch['feesId']); ?>">
              <div class="batch-attendance-details">Vedic Tree <?php  echo $batch['packageName']; ?></div>
            </a> 
            <?php } ?> 
          </div>
        </div>
