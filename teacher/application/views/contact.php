...
<body>
    ...
    <section class="contact_page section_padding">
        <div class="container">
            <h2 class="d-flex justify-content-center kid_title mb-4"> <span class="title_overlay_effect">Register Here</span></h2>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="studentName" class="form-control" value="<?php echo set_value('studentName');?>" placeholder="Enter  Full Name">
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" value="<?php echo set_value('studentMobile');?>" name="studentMobile" class="form-control" placeholder="Enter Phone">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo set_value('studentEmail');?>" name="studentEmail" class="form-control" placeholder="Enter Email">
                                <span style="color:red"><?php echo form_error('studentEmail');?></span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Enter Refferal Code</label>
                                <input type="text" value="<?php echo set_value('refferalCode');?>" class="form-control" name="refferalCode" placeholder="Enter refferal Code">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="Password" value="<?php echo set_value('studentPass');?>" class="form-control" name="studentPass" placeholder="Enter Password">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="password" id="passwordConfirm" value="<?php echo set_value('studentCPass');?>" class="form-control" name="studentCPass" placeholder="Enter Confirm Password">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Gender</label>
                                <div class="mt-2">
                                    <label class="radio-inline mr-2"><input type="radio" name="studentGender" value="Male" checked> Male</label>
                                    <label class="radio-inline"><input type="radio" name="studentGender" value="Female"> Female</label>
                                </div>
