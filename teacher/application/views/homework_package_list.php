    ...
    <div class="box11 animated_hero" style="background: #695FFE;">
      <div class="box-inside">
        <div class="desktop-mobile-view">
          ...
          <!-- //end top header -->
          <h1 style="font-weight: 800;color:darkorange" class="my-4">Batch Names</h1>
          <div class="batch-name">
            <?php foreach($student_attedence_batch as $batch) {?> 
            <!--<a href="<?php echo base_url('teacher/allocated_homework/'.$batch['feesId']); ?>">-->
               <a href="<?php echo base_url('teacher/upload_multiple/'.$batch['feesId']); ?>">
