<?php
    ...
    $cal_month_teacher = $usersession[0]['cal_month']; 
    $cal_allday        = json_decode($usersession[0]['cal_allday']);
        ...
        <div class="box11" style="background: #695FFE;">
            <div class="box-inside">
                <div class="desktop-mobile-view">
                    ...
                    <?php   
                           $get_learning_page_month_wisefilter  = get_learning_page_month_wisefilter();
                        ...
                        <div class="month-day-scroll">
                                ...
                                <div class="month-select">
                                    <select class="selectMonth" value="<?php echo set_value('fk_monthId'); ?>" name="fk_monthId">
                                        ...
                                        <?php if($teacher_status==2){ ?>
                                             <?php
                                                if($cal_month_teacher){
                                             ?>
                                             <option value="<?php echo $cal_month_teacher ?>">Month <?php echo $cal_month_teacher; ?></option>
                                             <?php }else { ?>
                                             <option value="1">Month 1 </option>
                                             <?php } ?>
                                        
                                        <?php }elseif($teacher_status==3){ ?>
                            ...
                            <div class="scrollbar" id="style-2">
                                <div class="days-list force-overflow">
                                    ...
                                    ?>
                                    <div  style="background-color:<?php echo $color; ?>" class="days days<?php echo $allday; ?>" id="<?php echo $allday; ?>">
                                    <?php echo "DAY ".$allday; ?>
                                    </div>
                                <?php
...
$(document).ready(function(){
 ...
 $(".days").click(function(){
    ...
    if(monthid=="" || monthid==null ){
        ...
        var url = "<?php echo base_url(); ?>teacher/vedic_learn/"+monthid+"/"+daysId+"/"+fk_classId+"/";  
