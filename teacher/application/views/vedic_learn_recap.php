        ...
        <div class="box-inside">
          <div class="desktop-mobile-view">
            ...
            <div class="d-flex justify-content-end mt-2">
                <a href="<?php echo base_url('teacher/recap/9')?>" style="font-weight: 500;font-size: x-large;border-radius: 40px;font-family: 'Source Sans Pro', sans-serif;" class="btn btn-primary" >For Next Session</a>
             </div>
          </div>
        </div>
      </div>
...
$(document).ready(function(){
    $(".topiclink").click(function(){
        ...
        window.location.href= "<?php echo base_url('teacher/vedic_learn_recap/'.$monthId.'/'.$dayId.'/'.$fk_classId.'/')?>"+vidId;
    });
});
