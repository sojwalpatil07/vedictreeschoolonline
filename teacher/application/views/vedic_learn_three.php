          ...
          <div class="desktop-mobile-view">
            ...
            <div class="d-flex justify-content-end mt-2">
                 ...
                 <?php } else{ ?>
                    ...
                    <a href="<?php echo base_url('teacher/course_three')?>" style="font-weight: 500;font-size: x-large;border-radius: 40px;font-family: 'Source Sans Pro', sans-serif;" class="btn btn-primary" >For Next Session</a>
...
$(document).ready(function(){
    ...
    window.location.href= "<?php echo base_url('teacher/vedic_learn_three/'.$monthId.'/'.$dayId.'/'.$fk_classId.'/')?>"+vidId;
