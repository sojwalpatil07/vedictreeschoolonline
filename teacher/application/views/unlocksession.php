                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        if($unlocksession_data){
                            $unlocksession_data_monthId = $unlocksession_data[0]['fk_monthId'];
                        }else{
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                ...
                                <form style="width:12px;"  method="POST" onclick="return check()" action="<?php echo base_url('dashboard/unlocksession');?>">
                                ...
                                <a href="<?php echo base_url('dashboard/unlockdays/'.$value['mId'].'/'.$studId)?>" class="gallery-popup" title="Open Imagination">
                                    <div class="project-item">
                                        <div class="overlay-container" style="height:100px;border-radius:100px;background-color:<?php echo $color;?>">
                                            <h1 class="ml-2" style="padding: 9% 22%;color: white;"><?php echo strtoupper($value['monthName']);?></h1>
                                        </div>
                                    </div>
                                </a>
                            </div>
