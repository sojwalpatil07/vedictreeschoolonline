                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="col-lg-6">
                                            <form class="" enctype="multipart/form-data" method="post" action="<?php echo base_url('dashboard/edit_video');?>">
          ...
          <script type="text/javascript">
            color = Math.floor((Math.random() * 4) + 1);
              ...
              $.notify({
                ...
                setTimeout(function() {
                    window.location.href = '<?php echo base_url('dashboard/classroom/'.$fk_classId)?>';
       }, 2000);
          </script>
