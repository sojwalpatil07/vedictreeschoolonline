            ...
            <div class="box-inside">
                <div class="desktop-mobile-view">
                    ...
                    <div class="d-flex justify-content-between my-4">
                        <h1 style="font-weight: 800;color:darkorange">Open Months And Days For Free Education Students</h1>
                       
                    </div>
                    <form method="POST" action="<?php echo base_url('teacher/provide_free_edu'); ?>">
                        <!--<div class="row">-->
                        ...
                        <div class="row">
                            <div class="form-group col-sm-2">
                                ...
                                <select type="text" class="form-control" id="" name="fk_monthId">
                            ...
                            <div class="form-group col-sm-2">
                                ...
                                <select type="text" class="form-control" id="" name="fk_dayId">
...
<?php if(isset($error)){ ?>
    ...
    setTimeout(function() {
                window.location.href = '<?php echo base_url('teacher/provide_free_edu')?>';
    }, 2000);
    </script>
<?php } ?>