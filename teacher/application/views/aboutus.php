            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-6 col-xl-5 order-2 order-lg-1">
                    <div class="about_section_content mt-5 mt-lg-0">
                        ...
                        <p class="wow fadeInLeft" data-wow-delay=".5s">Vedic tree is a technologically advanced, co-educational E-learning school. We call it Naye Zamane Ki….. Nayi School. We have a broad interest in the field of quality education and excellence committed to enabling academic development of young minds. We wish to empower the students to raise their academic and personal potential in a dynamic environment that values analysis, dedication and observation. We are a community which acts with sincerity and respects everyone's individuality, learning together as global citizens. Students flourish in an environment that provides a base for healthy development and encourages success.</p>
                    </div>
                </div>
            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-5 wow fadeInUp" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">
                    <div class="get_start_content mt-5 mt-lg-0">
                        ...
                        <p><span style="color:green; font-weight: 900;">VEDIC TREE</span> believes that Value Based Education is the key to success and Education is baseless if there are no values embedded in it. Hence at Vedic Tree the Curriculum has been designed in such a manner in which <span style="color: red;font-weight: 900;">VALUES & LIFE SKILL ACTIVITIES</span> are included in the day to day learning. Value based learning happens in a <span style="color:goldenrod;font-weight: 900;">PLAY & LEARN Method.</span></p>
