                                                    ...
                                                    <div data-repeater-item class="outer">
                                                        ...
                                                        <div class="form-group" >
                                                            <div class="form-group">
                                                               ...
                                                               <input type="url" class="form-control" name="relatedyoutubelink" placeholder="Youtube Link">
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="fk_upload_key" >
                                                                <option value="">Where to upload</option>
        ...
        <?php if(isset($error)){ ?>
          <script type="text/javascript">
            color = Math.floor((Math.random() * 4) + 1);
              ...
              setTimeout(function() {
                    window.location.href = '<?php echo base_url('dashboard/videouploading')?>';
       }, 2000);
