...
<div class="container">
    <div class="mobile-header">
        ...
        <div class="mobile-menu">
            <ul class="menu">
                <li class="menu-item"><a href="<?php echo base_url('teacher/teacher_dash_view');?>">Dashboard</a></li>
                <li class="menu-item"><a href="<?php echo base_url('teacher/sub_att');?>">Student Batches</a></li>
                <li class="menu-item"><a href="<?php echo base_url('teacher/final_studentlist_attedence');?>">View Student Attendance</a></li>
                  <li class="menu-item"><a href="<?php echo base_url('teacher/livesession');?>">Create  Live Session</a></li>
                  <li class="menu-item"><a href="<?php echo base_url('teacher/viewteacher');?>">Allocated Live Session</a></li>
				  <li class="menu-item"><a href="<?php echo base_url('teacher/teacher_attedence');?>">Teacher Attedence</a></li>
				  <li class="menu-item"><a href="<?php echo base_url('teacher/recap');?>">Recap Session</a></li>
				  <li class="menu-item"><a href="<?php echo base_url('vedic-dash/1');?>">Learning page</a></li>
				  <li class="menu-item"><a href="<?php echo base_url("teacher/substudentlist_reportcard");?>">Student list-reportcard</a></li>
				  <li class="menu-item"><a href="<?php echo base_url("teacher/vedic_value");?>">Value based Education</a></li>
