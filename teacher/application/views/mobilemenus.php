...
<div class="container">
    <div class="mobile-header">
        ...
        <div class="mobile-menu">
            <ul class="menu">
                <li class="menu-item"><a href="<?php echo base_url('vedic-dash');?>">Dashboard</a></li>
                <li class="menu-item">
                    <?php if(!empty($last_session_running)){ ?>
                    <a href="<?php echo base_url('website/vedic_learn/'.$last_session_running[0]['fk_monthId'].'/'.$last_session_running[0]['fk_dayId'].'/'.$last_session_running[0]['fk_classId'].'/0/his')?>">Learning Page</a>
                    <?php } else { ?>
                    <a href="<?php echo base_url('website/vedic_learn/1/1/'.$usersession[0]['teacherClass'])?>"> Learning Page</i>
                    <?php } ?>
                </li>
                <li class="menu-item"><a href="<?php echo base_url('website/vedicprofile')?>">Profile Page</a></li>
                <li class="menu-item"><a href="<?php echo base_url('vedic-value')?>"> Value Based Education</a></li>
                <!--<li class="menu-item"><a href="<?php //echo base_url('vedic-tracking');?>"> Video Tracking </a></li>-->
                <li class="menu-item"><a href="<?php echo base_url('website/vedicpayment');?>"> Payment </a></li>
                <li class="menu-item"><a href="<?php echo base_url('website/payment_his');?>"> Payment History</a></li>
				<li class="menu-item"><a href="<?php echo base_url('website/progress_tracker');?>">Progress Tracker</a></li>
            </ul>
        </div>
    </div>
</div>
