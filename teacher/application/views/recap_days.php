    ...
    $color = '#'.$rand[rand(0,15)].$rand[rand(0,15)].$rand[rand(0,15)].$rand[rand(0,15)].$rand[rand(0,15)].$rand[rand(0,15)];
                            ...
                            <div class="col-xl-3 col-md-6">
                                ...
                                <button  type="submit" name="submit" value="submit" class="btn btn-sm">
                                    <p style="float:right;"><i style="font-size: 27px;position: relative;margin-left:240px;top:32px;" class="mdi mdi-delete-forever"></i></p></button>           
                                </form>
                                </div>
                                <a href="<?php echo base_url('dashboard/get_day_sessions_recap/'.$value['dayId'].'/'.$monthId.'/'.$value['fk_classId'])?>" class="gallery-popup" title="Open Imagination">
