                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered  " style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url('uploads/Receiptpic/'.$value['Receiptpic'])?>" download="w3logo"><img src="<?php echo base_url('uploads/Receiptpic/'.$value['Receiptpic'])?>"></a></td>
                                                ...
                                                <td>
                                                        <form class="" method="POST" onclick="return check();" action="<?php echo base_url('dashboard/onboardinglist');?>">
                                                        ...
                                                        <button  type="submit" name="submit" value="submit" class="btn btn-sm btn-primary">Onrolled Student</button>
