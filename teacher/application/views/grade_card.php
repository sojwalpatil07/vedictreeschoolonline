...
<body>
    <div class="page main-report" size="A4" style="position: relative;">
        <div class="p-5">
            <div style="position: absolute;bottom: 22%;left: 44%;font-size: 22px;"><?php echo date("Y") ."-". date('Y', strtotime('+1 year'));?></div>
    ...
    <div class="mb-2"></div>
     <div class="page background-report-3" size="A4" style="position: relative">
        <div class="p-5">
            ...
            <div style="position: absolute;bottom: 39%;left: 41%;font-size: 22px;"><img src="<?php echo  base_url('uploads/teacher_signs/'.$userreport_detail[0]['sigh_upload']); ?>" alt=""></div>
        ...
        <!--<div class="p-5">-->
        <!--    <div style="position: absolute;bottom: 43.3%;right: 14%;font-size: 30px;"><?php echo $userreport_detail[0]['remark_one'] ?></div>-->
        <!--    <div style="position: absolute;bottom: 39%;right: 14%;font-size: 22px;"><img src="<?php echo  base_url('uploads/teacher_signs/'.$userreport_detail[0]['sigh_upload']); ?>" alt=""></div>-->
