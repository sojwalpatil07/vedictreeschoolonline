            ...
            <li class="">
                ...
                <li class="">
                        ...
                        <ul class="sub-menu mm-collapse" aria-expanded="false" >
                            ...
                            <li>
                                <a href="<?php echo base_url('dashboard/list_receipt');?>" class="waves-effect">
                                    <i class="fas fa-address-book"></i>
                                    <span>list All Receipt</span>
                                </a>
                            </li>
                            
                             <li>
                                <a href="<?php echo base_url('dashboard/add_division');?>" class="waves-effect">
                                    <i class="fas fa-address-book"></i>
                ...
                <li class="">
                        ...
                        <ul class="sub-menu mm-collapse" aria-expanded="false" >
                            ...
                            <li>
                                <a href="<?php echo base_url('dashboard/getinsternationallead');?>" class=" waves-effect">
                                    <i class="mdi mdi-clipboard-list-outline"></i>
                                    <span>Internation Lead</span>
                                </a>
                            </li>
                ...
                <li class="">
                        ...
                        <ul class="sub-menu mm-collapse" aria-expanded="false" >
                            ...
                            <li>
                                <a href="<?php echo base_url('dashboard/international_gallery');?>" class="waves-effect">
                                    <i style="font-size:large;" class="typcn typcn-group-outline"></i>
                                    <span>Add Internation Gallery</span>
                                </a>
                            </li>
                            
                            <li>
                                <a href="<?php echo base_url('dashboard/international_review');?>" class="waves-effect">
                                    <i style="font-size:large;" class="typcn typcn-group-outline"></i>
                                    <span>Add Internation Parents review </span>
                                </a>
                            </li>
                 ...
                 <li class="">
                        ...
                        <ul class="sub-menu mm-collapse" aria-expanded="false" >
                            ...
                            <li>
                                <a href="<?php echo base_url('dashboard/addevents');?>" class="waves-effect">
                                    <i style="font-size:large;" class="typcn typcn-group-outline"></i>
                            ...
                            <li>
                                <a href="<?php echo base_url('dashboard/eventlist');?>" class="waves-effect">
                                    <i style="font-size:large;" class="typcn typcn-group-outline"></i>
