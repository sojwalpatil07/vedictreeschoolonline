...
<body>
    ...
    <div class="promo-code">
        ...
        <a href="<?php echo base_url('register?prcode=freeintro') ?>" target="_blank">
    ...
    <section class="fetures_part padding_bottom" id="50off_fees_section">
        <div class="container">
            ...
            <div class="row justify-content-between">
                <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="single_fetures_part lightviolet_bg">
                        ...
                        <h4> <a href="<?php echo base_url('nursery-preschoolapp'); ?>"><span class="strike">&#8377 47,999/-</span> &#8377 23,999/-</a></h4>
                ...
                <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
                    <div class="single_fetures_part pink_bg">
                        ...
                        <h4> <a href="<?php echo base_url('educational-app-kids-4-5-year-olds'); ?>"><span class="strike">&#8377 49,999/-</span> &#8377 24,999/-</a></h4>
                        <div class="enroll-now">
                            <a href="<?php echo base_url('nursery-preschoolapp'); ?>" class="enroll-button">Enroll Now</a>
                ...
                <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay=".8s">
                    <div class="single_fetures_part">
                        ...
                        <h4> <a href="<?php echo base_url('online-learning-app-kids-5-6-year-olds'); ?>"> <span class="strike">&#8377 51,999/-</span> &#8377 25,999/-</a></h4>
                        <div class="enroll-now">
                            <a href="<?php echo base_url('nursery-preschoolapp'); ?>" class="enroll-button">Enroll Now</a>
                        </div>
                    </div>
            ...
            <div class="d-flex justify-content-center mt-3" style="text-align: center;">
                <p style="font-size: 18px;color:#0748ef;font-weight:600">The above charges are all inclusive (Fees & Kit Charges)</p>
            </div>
            <div class="d-flex justify-content-center" style="text-align: center;">
                <p style="font-size: 18px;color:#0748ef;font-weight:600">EMI Options Available</p>
            </div>
        </div>
        </div>
    ...
    <section class="comparison-table section_padding" >
        <div class="container">
            <div class="row justify-content-center" id="stickytypeheader" class="header-sticky">
                <div class="col-lg-12" style="background: #fff;">
                    <div class="comparison section_tittle_style_02">
                        <h1 class="title" data-wow-delay=".3s"> <span class="">Our Mission And Vision </span></h1>
                ...
                <div class="col-lg-12">
                    <div class="our-features-section">
                        <div class="our-features-details border-orange"><img src="<?php echo base_url() ?>assets/website/img/features/High-Quality-Emmersive-Sessions.png" loading="lazy" alt="High-Quality-Emmersive-Sessions">
                            <p class="yellow-color">HIGH QUALITY IMMERSIVE LIVE SESSIONS</p>
                        </div>
                        <div class="our-features-details border-yellow"><img src="<?php echo base_url() ?>assets/website/img/features/Value-Based-Education.png" loading="lazy" alt="Value-Based-Education">
                            <p class="orange-color">VALUE BASED EDUCATION</p>
                        </div>
                        <div class="our-features-details border-blue"><img src="<?php echo base_url() ?>assets/website/img/features/Blending-Curriculum.png" loading="lazy" alt="Blending-Curriculum">
                            <p class="lightblue-color">BLENDED CURRICULUM</p>
                        </div>
                    </div>
                    <div class="our-feature-wrp">
                        <div class="our-features-details border-green"><img class="responsive" src="<?php echo base_url() ?>assets/website/img/features/HD-Animated-Videos.png" loading="lazy" alt="HD-Animated-Videos">
                            <p class="greenlight">HD ANIMATED VIDEOS</p>
                        </div>
...
<?php if (isset($errorsweet)) { ?>
    <script type="text/javascript">
        swal("<?php if (isset($errorsweet)) {
                    echo $errorsweet['error'];
                } ?>");
    </script>
<?php } ?>
