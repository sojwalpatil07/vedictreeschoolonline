...
function addphysicalfees(){
    ...
    $data['list_division'] = $this->regModel->list_division();
...
function addfeesphysical(){
    ...
    if($usersession[0]['adminRole'] == 6 || $usersession[0]['adminRole'] == 1)
    {
        ...
        if(isset($_POST['submit']))
        {
            ...
            $this->form_validation->set_rules('fk_divId', 'fk divId ', 'trim|required');
            $this->form_validation->set_rules('gender', 'gender', 'trim|required');
            $this->form_validation->set_rules('student_dob', 'student dob', 'trim|required');
            ...
            else
            {
                        ...
                        $fk_divId                  = $this->input->post('fk_divId');
...
function filterclasswise(){
    ...
    if($usersession[0]['adminRole'] == 6 || $usersession[0]['adminRole'] == 1)
    {
         if(isset($_POST['submit']))
        {
            ...
            $this->form_validation->set_error_delimiters('<span>', '</span>');
            $this->form_validation->set_rules('fk_classId', 'fk_classId', 'trim|required|integer');
            ...
            else
            {
                        ...
                        $fk_classId =  $this->input->post('fk_classId');
                        $res = $this->regModel->filterclasswise_receipt($fk_classId);
                        if(!empty($res)){
                            $data['list_receipt'] = $res;
                        }else{
                            $data['list_receipt'] = $res;
                        }
                         $this->load->view('list_receipt',$data);
...
function editfeesphysical(){
    ...
    if($usersession[0]['adminRole'] == 6 || $usersession[0]['adminRole'] == 1)
    {
        ...
        if(isset($_POST['submit']))
        {
            ...
            $this->form_validation->set_rules('fk_divid', 'fk_divId', 'trim|required');
       ...
       $usersession = $this->session->userdata('usersession');
        if(isset($_POST['submit']))
        {
              ...
              else
              {
                ...
                $insertdata = array('divName'=>$divName);
                $cechknamedivision = $this->regModel->cechknamedivision($divName);
                if($cechknamedivision==1){
                    $data['error'] = array('error' => "division Name Already added Successfully !");
                   $data['list_division'] = $this->regModel->list_division();
                    $this->load->view('add_division',$data);
                }else{
                $result = $this->regModel->add_division($insertdata);
                 if($result==1){
                    $data['error'] = array('error' => "division Name added Successfully !");
                   $data['list_division'] = $this->regModel->list_division();
                    $this->load->view('add_division',$data);
                 }else{
                    $data['error'] = array('error' => "division Name not added Successfully !");
                   $data['list_division'] = $this->regModel->list_division();
                    $this->load->view('add_division',$data);
                 }
                }
    ...
    if($usersession[0]['adminRole']==1 || $usersession[0]['adminRole']==6 ){
       ...
       $usersession = $this->session->userdata('usersession');
        if(isset($_POST['submit']))
        {
              ...
              $this->form_validation->set_error_delimiters('<span>', '</span>');
              $this->form_validation->set_rules('divId', 'divId', "trim|required");
              if ($this->form_validation->run() == FALSE)
              {     
                   $data['list_division'] = $this->regModel->list_division();
                   $this->load->view('add_division',$data);
              ...
              else
              {
                ...
                $result = $this->regModel->delete_division($divId);
                 if($result==1){
                    $data['error'] = array('error' => "Div Id Deleted Successfully !");
                   $data['list_division'] = $this->regModel->list_division();
                    $this->load->view('add_division',$data);
                 }else{
                    $data['error'] = array('error' => "Div Id Not Deleted Successfully !");
                   $data['list_division'] = $this->regModel->list_division();
                    $this->load->view('add_division',$data);
                 }
              }         
...
function addevents(){
    $usersession = $this->session->userdata('usersession');
    if($usersession[0]['adminRole'] == 5 || $usersession[0]['adminRole'] == 6 || $usersession[0]['adminRole'] == 1)
    {
     $data['eventlist'] = $this->regModel->eventlist();
    ...
    if($usersession[0]['adminRole']==5 || $usersession[0]['adminRole']==6 ||$usersession[0]['adminRole'] == 1 ){
       ...
       $usersession = $this->session->userdata('usersession');
        if(isset($_POST['submit']))
        {
              ...
              $this->form_validation->set_error_delimiters('<span>', '</span>');
              $this->form_validation->set_rules('eventName', 'eventName', "trim|required");
              $this->form_validation->set_rules('eventurl', 'eventurl', "trim|required");
              $this->form_validation->set_rules('eventDate', 'eventDate', "trim|required");
              if ($this->form_validation->run() == FALSE)
              {     
                   $data['eventlist'] = $this->regModel->eventlist();
              ...
              else
              {
                ...
                $insertData = array(
                                    ...
                                    ;
                $result = $this->regModel->addeventsdata($insertData);
                 if($result==1){
                    $data['error'] = array('error' => "Event Added");
                   $data['eventlist'] = $this->regModel->eventlist();
                    $this->load->view('addevents',$data);
                 }else{
                    $data['error'] = array('error' => "Event not added !");
                   $data['eventlist'] = $this->regModel->eventlist();
                    $this->load->view('addevents',$data);
                 }
              }         
       ...
       $usersession = $this->session->userdata('usersession');
        if(isset($_POST['submit']))
        {
              ...
              else
              {
                ...
                $result = $this->regModel->delete_events($eventId);
                 if($result==1){
                    $data['error'] = array('error' => "Event Id Deleted Successfully !");
                   $data['eventlist'] = $this->regModel->eventlist();
                    $this->load->view('addevents',$data);
                 }else{
                    $data['error'] = array('error' => "Event Id Not Deleted Successfully !");
                   $data['eventlist'] = $this->regModel->eventlist();
                    $this->load->view('addevents',$data);
                 }
              }         
...
public function getinsternationallead()
{
  
    $usersession = $this->session->userdata('usersession');
  
  if($usersession[0]['adminRole']==1 || $usersession[0]['adminRole']==6 || $usersession[0]['adminRole']==4 || $usersession[0]['adminRole']==3 ){

      if($this->session->userdata('usersession'))
      {
        $data['getinsternationallead'] = $this->regModel->getinsternationallead(); 
         $this->load->view('getinsternationallead',$data);
      } else {
        redirect('welcome');
      }
...
public function international_gallery()
{
  ...
  if($usersession[0]['adminRole']==1 || $usersession[0]['adminRole']==5){
      ...
      if($this->session->userdata('usersession'))
      {
        $data['international_gallery'] = $this->regModel->international_gallery(); 
         $this->load->view('international_gallery',$data);
      } else {
        redirect('welcome');
      }
...
public function add_international_gallery()
{
  ...
  if($usersession[0]['adminRole']==1 || $usersession[0]['adminRole']==5){
        ...
        {
          $this->form_validation->set_error_delimiters('<span>', '</span>');
          $this->form_validation->set_rules('gdate', 'fk_classId', 'trim|required');
          $this->form_validation->set_rules('gname', 'content_title', 'trim|required');
          ...
          else
          {
                ...
                if(!empty($_FILES)){
                    $contentfile        = $_FILES['gpics']['name'];
                }else{
                    $contentfile = "";
                }
                

                $config['upload_path']          = './uploads/international_gallery';
                $config['allowed_types']        = 'gif|jpg|png|jpeg|pdf|doc|docx|xls|xlsx|pps|ppsx|ppt|pptx|gz|tgz|zip';

                $this->load->library('upload', $config);
                $this->upload->initialize($config);

                if ( ! $this->upload->do_upload('gpics'))
                {
                        $data['error'] = array('gpics' => $this->upload->display_errors());
                        $this->load->view('international_gallery', $data);
                }
                else
                {
                        $data = array('gpics' => $this->upload->data());
                        $contentfile = $data['gpics']['file_name'];
                }
                ...
                $videouploadingdata = array(  
                  ...
                  $res = $this->regModel->add_international_gallery($videouploadingdata);
                  if($res==1){
                         $data['error'] = array('error' => "gallery Created Successfully !");
                         $data['international_gallery'] = $this->regModel->international_gallery(); 
                         $this->load->view('international_gallery',$data);
                   } else {
                          $data['error'] = array('error' => "gallery not Created Successfully !");
                          $data['international_gallery'] = $this->regModel->international_gallery(); 
                          $this->load->view('international_gallery',$data);
                  }
...
function delete_international_gallery(){
    ...
    if($usersession[0]['adminRole']==1 || $usersession[0]['adminRole']==6 ){
       ...
       $usersession = $this->session->userdata('usersession');
        if(isset($_POST['submit']))
        {
              ...
              {
                $gid     = $this->input->post('gid');
                $result = $this->regModel->delete_international_gallery($gid);
                 if($result==1){
                    $data['error'] = array('error' => "Gallery Id Deleted Successfully !");
                   $data['international_gallery'] = $this->regModel->international_gallery();
                    $this->load->view('international_gallery',$data);
                 }else{
                    $data['error'] = array('error' => "Gallery Id Not Deleted Successfully !");
                  $data['international_gallery'] = $this->regModel->international_gallery();
                    $this->load->view('international_gallery',$data);
                 }
              }         
  ...
  public function international_review()
  {
       $usersession = $this->session->userdata('usersession');
      ...
      if($this->session->userdata('usersession'))
      {
        $data['international_review'] = $this->regModel->international_review(); 
         $this->load->view('international_review',$data);
      } else {
        redirect('welcome');
      }
  ...
  public function add_international_review()
  {
       $usersession = $this->session->userdata('usersession');
  ...
  if($usersession[0]['adminRole']==1 || $usersession[0]['adminRole']==5 ){
    ...
    if(isset($_POST['submit']))
    {
          ...
          $this->form_validation->set_rules('rdesc', 'rdesc', 'trim|required');
          ...
          else
          {
                ...
                if(!empty($_FILES)){
                    $contentfile        = $_FILES['rpics']['name'];
                }else{
                    $contentfile = "";
                }
                

                $config['upload_path']          = './uploads/international_review';
                $config['allowed_types']        = 'gif|jpg|png|jpeg|pdf|doc|docx|xls|xlsx|pps|ppsx|ppt|pptx|gz|tgz|zip';

                $this->load->library('upload', $config);
                $this->upload->initialize($config);

                if ( ! $this->upload->do_upload('rpics'))
                {
                        $data['error'] = array('rpics' => $this->upload->display_errors());
                         $data['international_review'] = $this->regModel->international_review(); 
                        $this->load->view('international_review', $data);
                }
                else
                {
                        $data = array('rpics' => $this->upload->data());
                        $contentfile = $data['rpics']['file_name'];
                }
                ...
                $videouploadingdata = array(  
                  ...
                  $res = $this->regModel->add_international_review($videouploadingdata);
                  if($res==1){
                         $data['error'] = array('error' => "Review Created Successfully !");
                         $data['international_review'] = $this->regModel->international_review(); 
                         $this->load->view('international_review',$data);
                   } else {
                          $data['error'] = array('error' => "Review not Created Successfully !");
                          $data['international_review'] = $this->regModel->international_review(); 
                          $this->load->view('international_review',$data);
                  }
  ...
  function delete_international_review(){
    ...
    if($usersession[0]['adminRole']==1 || $usersession[0]['adminRole']==6 ){
       ...
       $usersession = $this->session->userdata('usersession');
        if(isset($_POST['submit']))
        {
              ...
              $this->form_validation->set_error_delimiters('<span>', '</span>');
              $this->form_validation->set_rules('rid', 'rid', "trim|required");
              if ($this->form_validation->run() == FALSE)
              {     
                   $data['international_review'] = $this->regModel->international_review(); 
                   $this->load->view('international_review',$data);
              ...
              else
              {
                ...
                $result      = $this->regModel->delete_international_review($rid);
                 if($result==1){
                    $data['error'] = array('error' => "Review Id Deleted Successfully !");
                   $data['international_review'] = $this->regModel->international_review(); 
                    $this->load->view('international_review',$data);
                 }else{
                    $data['error'] = array('error' => "Review Id Not Deleted Successfully !");
                   $data['international_review'] = $this->regModel->international_review(); 
                    $this->load->view('international_review',$data);
                 }
              }         
...
function getbonafied(){
    
     $usersession = $this->session->userdata('usersession');
    if($usersession[0]['adminRole']==1 || $usersession[0]['adminRole']==6 ){
        
         $id     = $this->uri->segment(3);
        $data['studdata'] = $this->regModel->edit($id);
        $this->load->view('getbonafied',$data);
...
function getbonafiedphy(){
    
     $usersession = $this->session->userdata('usersession');
    if($usersession[0]['adminRole']==1 || $usersession[0]['adminRole']==6 ){
        
         $id     = $this->uri->segment(3);
        $data['studdata'] = $this->regModel->getbonafiedphy($id);
        $this->load->view('getbonafiedphy',$data);
